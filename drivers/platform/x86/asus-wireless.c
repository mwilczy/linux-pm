...
static int asus_wireless_add(struct acpi_device *adev)
{
	...
	return acpi_device_install_notify_handler(adev, ACPI_DEVICE_NOTIFY, asus_wireless_notify);
}
...
static void asus_wireless_remove(struct acpi_device *adev)
{
	...
	acpi_device_remove_notify_handler(adev, ACPI_DEVICE_NOTIFY, asus_wireless_notify);
}
